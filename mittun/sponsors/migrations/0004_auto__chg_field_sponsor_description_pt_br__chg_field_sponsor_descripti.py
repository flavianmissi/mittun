...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('sponsors_sponsor', 'description_pt_br', self.gf('django.db.models.fields.TextField')(max_length=1000, null=True))

        # Changing field 'Sponsor.description_en_us'
        db.alter_column('sponsors_sponsor', 'description_en_us', self.gf('django.db.models.fields.TextField')(max_length=1000))
    ...
    models = {
        ...
        'sponsors.sponsor': {
            ...
            'description_en_us': ('django.db.models.fields.TextField', [], {'max_length': '1000'}),
            'description_pt_br': ('django.db.models.fields.TextField', [], {'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
